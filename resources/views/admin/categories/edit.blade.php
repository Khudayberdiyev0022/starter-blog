      ...
      <div class="card">
        <div class="card-header">
          <div class="d-flex justify-content-between align-items-center w-100">
            <h4><i class="fas fa-sitemap"></i> Category Edit</h4>
            <div>
              <a href="{{ route('admin.categories.index') }}" class="btn btn-light"><i class="fas fa-list"></i> Lists</a>
            </div>
          </div>
        </div>
        <div class="card-body">
            ...
            <div class="row">
              <div class="col-8">
                ...
                <div class="form-group">
                  ...
                  <input type="text" name="slug" id="slug" value="{{ $category->slug }}" class="form-control @error('slug') is-invalid @enderror">
                  @error('slug')
                  <span class="invalid-feedback">{{ $message }}</span>
                  @enderror
                </div>
                ...
                <div class="row">
                  ...
                  <div class="col-2">
                    <div class="form-group">
                      ...
                      <input type="number" name="order" class="form-control @error('order') is-invalid @enderror" value="{{ $category->order }}">
                      @error('order')
                      <span class="invalid-feedback">{{ $message }}</span>
                      @enderror
                    </div>
