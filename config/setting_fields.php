  ...
  'app'        => [
    ...
    'elements' => [
      ...
      [
        ...
        'class' => '', // any class for input
        'value' => '<a href="https://github.com/Khudayberdiyev0022/starter-blog" class="text-muted" target="_blank">Built with ♥ from Khamza</a>', // default value if you want
      ],
      [
  ...
  'social'     => [
    ...
    'elements' => [
      [
        ...
        'class' => '', // any class for input
        'value' => 'https://khamza.uz', // default value if you want
      ],
      [
        'type'  => 'text', // input fields type
        'data'  => 'string', // data type, string, int, boolean
      ...
      [
        ...
        'rules' => 'required|nullable|max:191', // validation rule of laravel
        'class' => '', // any class for input
        'value' => 'https://www.youtube.com/', // default value if you want
      ],
      [
        'type'  => 'text', // input fields type
        'data'  => 'string', // data type, string, int, boolean
  ...
  'meta'       => [
    ...
    'elements' => [
      ...
      [
        ...
        'rules' => '', // validation rule of laravel
        'class' => '', // any class for input
        'value' => '@khamza', // default value if you want
      ],
      [
        'type'  => 'text', // input fields type
        'data'  => 'text', // data type, string, int, boolean
